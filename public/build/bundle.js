...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*month*/ 1) set_data_dev(t1, /*month*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    ...
    class Wheel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { month: 0 });
    ...
    // (17:2) {#each data as d, i}
    function create_each_block(ctx) {
    	let t0;
    	let t1;
    	let t2_value = JSON.stringify(/*d*/ ctx[3]) + "";
    	let t2;
    	let t3;
    	let br;
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			br = element("br");
    			add_location(br, file$1, 17, 29, 326);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(14:17)   ... loading...  {:then data}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let promise_1;
    	let current;
    	const wheel = new Wheel({ props: { month: "Nov" }, $$inline: true });
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, h1);
    			append_dev(main, t1);
    			mount_component(wheel, main, null);
    			append_dev(main, t2);
